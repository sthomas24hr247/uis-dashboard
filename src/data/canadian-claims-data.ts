...
export const CA_MOCK_CLAIMS = [
  { id: "ca001", patientId: "PT-CA-001", patientName: "Liam Tremblay",  patientAge: 4, clinic: "Coastal North Dental — Toronto Downtown",    claimDate: "03/12/2026", cdtCode: "93111", procedure: "General Anaesthesia - First 30 Min", carrier: "CDCP (Canadian Dental Care Plan)", billedAmt: 1248, denialCode: "CDCP-102", denialReason: "Medical necessity not established",  status: "denied",             daysOld: 38, priority: "critical", claimType: "PREAUTH",   issues: ["Narrative missing criterion (ii) - behaviour management history not documented", "No dates or outcomes for nitrous/oral sedation attempts", "Behaviour scale score not included"] },
  { id: "ca002", patientId: "PT-CA-002", patientName: "Emma Osei",      patientAge: 6, clinic: "Coastal North Dental — Mississauga Square One", claimDate: "03/01/2026", cdtCode: "93111", procedure: "General Anaesthesia - First 30 Min", carrier: "Sun Life Financial",                billedAmt: 936,  denialCode: "CDCP-103", denialReason: "Step therapy not documented",         status: "denied",             daysOld: 49, priority: "high",     claimType: "PREAUTH",   issues: ["No documentation of nitrous oxide attempt prior to GA request", "Step therapy protocol not followed per CDCP Section 4.2.3", "Attach clinical notes showing lower-level sedation outcomes"] },
  { id: "ca003", patientId: "PT-CA-003", patientName: "Noah Bergeron",  patientAge: 5, clinic: "Coastal North Dental — Toronto Downtown",    claimDate: "02/14/2026", cdtCode: "93111", procedure: "General Anaesthesia - First 30 Min", carrier: "Canada Life",                       billedAmt: 1560, denialCode: "CDCP-101", denialReason: "Predetermination not obtained",     status: "ai_scanned",         daysOld: 64, priority: "critical", claimType: "EMERGENCY", issues: ["GA performed without predetermination approval", "Emergency exception not documented", "Attach emergency certification and acute presentation notes"] },
  { id: "ca004", patientId: "PT-CA-004", patientName: "Olivia Singh",   patientAge: 8, clinic: "Coastal North Dental — Brampton Bramalea",   claimDate: "03/20/2026", cdtCode: "93111", procedure: "General Anaesthesia - First 30 Min", carrier: "Manulife",                          billedAmt: 780,  denialCode: "SL-201",   denialReason: "Annual benefit maximum exceeded",   status: "denied",             daysOld: 30, priority: "medium",   claimType: "PREAUTH",   issues: ["Patient annual dental maximum of $2,000 reached for 2026 policy year", "Coordinate benefits with secondary carrier", "Verify CDCP eligibility for remainder"] },
  { id: "ca005", patientId: "PT-CA-005", patientName: "Mason Leblanc",  patientAge: 3, clinic: "Coastal North Dental — Toronto Downtown",    claimDate: "01/28/2026", cdtCode: "93111", procedure: "General Anaesthesia - First 30 Min", carrier: "CDCP (Canadian Dental Care Plan)", billedAmt: 1872, denialCode: "CDCP-105", denialReason: "Missing clinical documentation",     status: "addendum_generated", daysOld: 81, priority: "high",     claimType: "PREAUTH",   issues: ["Anaesthesia record not attached to submission", "Radiographs missing from predetermination package", "CDCP predetermination form incomplete - Section 3 unsigned"] },
];
